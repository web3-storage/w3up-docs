...
Create a space using your default agent
...
Upload something to your account
...
Get the DID of the agent you want to delegate to
...
Delegate access to the new Agent DID
...
Add the delegated space to the second agent
...
Upload to the space from the second agent
